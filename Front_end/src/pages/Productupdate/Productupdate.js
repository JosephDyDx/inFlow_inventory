...
const Productupdate = () => {
  ...
  return (
    <>
      <div className="productup-arrow">
        <NavLink to="/product">
          <HiArrowSmallLeft style={arrowStyle} />
        </NavLink>
        <p className="productup-arrow-para">Product Update</p>
      </div>
      <div className="productup-head">
      ...
      <div className="update-link">
        <NavLink to="/" className="save-link">
          Save
        </NavLink>
        <CustomButton to="/Dashboard" className="save-btn">
          Submit
        </CustomButton>
      </div>
    </>
